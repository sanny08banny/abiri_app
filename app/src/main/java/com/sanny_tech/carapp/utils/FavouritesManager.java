...
public class FavouritesManager {
    ...
    private static final String KEY_HISTORY = "favourites";
    ...
    public static List<String> getFavouritesByQuery(Context context, String query) {
        List<String> history = getFavourites(context);
    ...
    public static void clearFavourites(Context context) {
        SharedPreferences preferences = context.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE);
